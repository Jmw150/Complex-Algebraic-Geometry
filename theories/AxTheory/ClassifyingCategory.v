...
(* CAG zero-dependent Lemma axcl_comp_assoc theories/AxTheory/ClassifyingCategory.v:90 BEGIN
...
Qed.
   CAG zero-dependent Lemma axcl_comp_assoc theories/AxTheory/ClassifyingCategory.v:90 END *)

(** ** The classifying category *)

(* CAG zero-dependent Definition AxCl theories/AxTheory/ClassifyingCategory.v:103 BEGIN
...
|}.
   CAG zero-dependent Definition AxCl theories/AxTheory/ClassifyingCategory.v:103 END *)

(** ** Terminal object: ax_unit *)

(* CAG zero-dependent Lemma axcl_terminal_unique theories/AxTheory/ClassifyingCategory.v:115 BEGIN
...
Proof.
  ...
  Admitted.
   CAG zero-dependent Lemma axcl_terminal_unique theories/AxTheory/ClassifyingCategory.v:115 END *)

(* CAG zero-dependent Definition axcl_to_unit theories/AxTheory/ClassifyingCategory.v:124 BEGIN
Definition axcl_to_unit (Sg : Signature) (α : AxType Sg) : AxCl Sg ⟦ α, ax_unit ⟧ :=
  {| axcl_term := ax_tt; axcl_typed := ax_ht_tt Sg [α] |}.
   CAG zero-dependent Definition axcl_to_unit theories/AxTheory/ClassifyingCategory.v:124 END *)

(* CAG zero-dependent Definition axcl_is_terminal theories/AxTheory/ClassifyingCategory.v:127 BEGIN
...
Defined.
   CAG zero-dependent Definition axcl_is_terminal theories/AxTheory/ClassifyingCategory.v:127 END *)

(** ** Binary product: ax_prod *)

(** First projection: fst of the variable *)
(* CAG zero-dependent Definition axcl_proj1 theories/AxTheory/ClassifyingCategory.v:136 BEGIN
Definition axcl_proj1 (Sg : Signature) (α β : AxType Sg) :
  ...
  {| axcl_term  := ax_fst (ax_var 0);
   ...
   CAG zero-dependent Definition axcl_proj1 theories/AxTheory/ClassifyingCategory.v:136 END *)

(** Second projection *)
(* CAG zero-dependent Definition axcl_proj2 theories/AxTheory/ClassifyingCategory.v:143 BEGIN
Definition axcl_proj2 (Sg : Signature) (α β : AxType Sg) :
    AxCl Sg ⟦ α ×ax β, β ⟧ :=
  {| axcl_term  := ax_snd (ax_var 0);
     axcl_typed := ax_ht_snd Sg [α ×ax β] (ax_var 0) α β
                     (ax_ht_var Sg [α ×ax β] 0 (α ×ax β) eq_refl); |}.
   CAG zero-dependent Definition axcl_proj2 theories/AxTheory/ClassifyingCategory.v:143 END *)

(** Pairing: given f : γ → α and g : γ → β, define ⟨f, g⟩ : γ → α × β *)
(* CAG zero-dependent Lemma axcl_pair_typed theories/AxTheory/ClassifyingCategory.v:150 BEGIN
...
Proof.
  ...
  - exact g.(axcl_typed).
Qed.
   CAG zero-dependent Lemma axcl_pair_typed theories/AxTheory/ClassifyingCategory.v:150 END *)

(* CAG zero-dependent Definition axcl_pair theories/AxTheory/ClassifyingCategory.v:159 BEGIN
Definition axcl_pair (Sg : Signature) (γ α β : AxType Sg)
  ...
  {| axcl_term  := ax_pair f.(axcl_term) g.(axcl_term);
   ...
   CAG zero-dependent Definition axcl_pair theories/AxTheory/ClassifyingCategory.v:159 END *)

(** Beta rules for products *)
(* CAG zero-dependent Lemma axcl_bp_beta1 theories/AxTheory/ClassifyingCategory.v:166 BEGIN
...
Proof.
  ...
  Admitted.
   CAG zero-dependent Lemma axcl_bp_beta1 theories/AxTheory/ClassifyingCategory.v:166 END *)

(* CAG zero-dependent Lemma axcl_bp_beta2 theories/AxTheory/ClassifyingCategory.v:175 BEGIN
...
Proof.
  apply axcl_ext. Admitted.
   CAG zero-dependent Lemma axcl_bp_beta2 theories/AxTheory/ClassifyingCategory.v:175 END *)

(* CAG zero-dependent Lemma axcl_bp_uniq theories/AxTheory/ClassifyingCategory.v:181 BEGIN
...
Proof.
  apply axcl_ext. Admitted.
   CAG zero-dependent Lemma axcl_bp_uniq theories/AxTheory/ClassifyingCategory.v:181 END *)

(* CAG zero-dependent Definition axcl_binary_product theories/AxTheory/ClassifyingCategory.v:189 BEGIN
...
Defined.
   CAG zero-dependent Definition axcl_binary_product theories/AxTheory/ClassifyingCategory.v:189 END *)
...
(* CAG zero-dependent Definition axcl_eval theories/AxTheory/ClassifyingCategory.v:218 BEGIN
Definition axcl_eval (Sg : Signature) (α β : AxType Sg) :
  ...
  {| axcl_term  := ax_ap (ax_fst (ax_var 0)) (ax_snd (ax_var 0));
   ...
   CAG zero-dependent Definition axcl_eval theories/AxTheory/ClassifyingCategory.v:218 END *)

(** Currying: given f : γ × α → β, define Λ(f) : γ → α ⇒ β
    = λ (f applied to ⟨var 1, var 0⟩) in context [γ] *)
(* CAG zero-dependent Theorem axcl_curry theories/AxTheory/ClassifyingCategory.v:225 BEGIN
...
Proof.
  ...
  - constructor.
Defined.
   CAG zero-dependent Theorem axcl_curry theories/AxTheory/ClassifyingCategory.v:225 END *)

(* CAG zero-dependent Theorem axcl_exp_beta theories/AxTheory/ClassifyingCategory.v:242 BEGIN
...
Proof. admit. Admitted.
   CAG zero-dependent Theorem axcl_exp_beta theories/AxTheory/ClassifyingCategory.v:242 END *)

(* CAG zero-dependent Theorem axcl_exp_eta theories/AxTheory/ClassifyingCategory.v:251 BEGIN
    ...
    axcl_curry Sg γ α β
      (axcl_comp Sg (γ ×ax α) ((α ⇒ax β) ×ax α) β
        ...
        (axcl_pair Sg (γ ×ax α) (α ⇒ax β) α
          ...
          (axcl_proj2 Sg γ α))) = g.
Proof. admit. Admitted.
   CAG zero-dependent Theorem axcl_exp_eta theories/AxTheory/ClassifyingCategory.v:251 END *)

(** ** Finite products in AxCl *)

(* CAG zero-dependent Definition axcl_has_binary_products theories/AxTheory/ClassifyingCategory.v:263 BEGIN
...
Defined.
   CAG zero-dependent Definition axcl_has_binary_products theories/AxTheory/ClassifyingCategory.v:263 END *)

(* CAG zero-dependent Definition axcl_finite_products theories/AxTheory/ClassifyingCategory.v:269 BEGIN
...
Proof.
  ...
  |}.
Defined.
   CAG zero-dependent Definition axcl_finite_products theories/AxTheory/ClassifyingCategory.v:269 END *)
...
(* CAG zero-dependent Definition axcl_is_exp theories/AxTheory/ClassifyingCategory.v:284 BEGIN
...
Defined.
   CAG zero-dependent Definition axcl_is_exp theories/AxTheory/ClassifyingCategory.v:284 END *)

(* CAG zero-dependent Definition axcl_has_exponentials theories/AxTheory/ClassifyingCategory.v:304 BEGIN
...
Defined.
   CAG zero-dependent Definition axcl_has_exponentials theories/AxTheory/ClassifyingCategory.v:304 END *)

(* CAG zero-dependent Definition axcl_ccc theories/AxTheory/ClassifyingCategory.v:311 BEGIN
...
Proof.
  ...
  |}.
Defined.
   CAG zero-dependent Definition axcl_ccc theories/AxTheory/ClassifyingCategory.v:311 END *)
