...
(* CAG zero-dependent Definition I_alg_functor theories/AxTheory/GeneratedFunctionalTheory.v:92 BEGIN
Definition I_alg_functor (Th : Theory) :
    Functor (Cl Th.(th_sig)) (AxCl Th.(th_sig)) :=
  I_functor Th.(th_sig).
   CAG zero-dependent Definition I_alg_functor theories/AxTheory/GeneratedFunctionalTheory.v:92 END *)
...
(* CAG zero-dependent Admitted ground_type_conservativity theories/AxTheory/GeneratedFunctionalTheory.v:116 BEGIN
...
Proof.
  ...
  Admitted.
   CAG zero-dependent Admitted ground_type_conservativity theories/AxTheory/GeneratedFunctionalTheory.v:116 END *)
