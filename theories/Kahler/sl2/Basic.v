...
(* CAG zero-dependent Lemma Y_power_weight theories/Kahler/sl2/Basic.v:171 BEGIN
...
Qed.
   CAG zero-dependent Lemma Y_power_weight theories/Kahler/sl2/Basic.v:171 END *)
...
(* CAG zero-dependent Theorem XY_primitive_identity theories/Kahler/sl2/Basic.v:270 BEGIN
...
Proof.
  ...
  - (** Inductive case: assume the identity at k, prove at S k. *)
    ...
    + (** im component — same ring arithmetic *)
      ...
      rewrite Hk1, Hk2. ring.
Qed.
   CAG zero-dependent Theorem XY_primitive_identity theories/Kahler/sl2/Basic.v:270 END *)
...
(* CAG zero-dependent Lemma orbit_H_stable theories/Kahler/sl2/Basic.v:369 BEGIN
...
Qed.
   CAG zero-dependent Lemma orbit_H_stable theories/Kahler/sl2/Basic.v:369 END *)
...
(* CAG zero-dependent Lemma weight_space_scale theories/Kahler/sl2/Basic.v:431 BEGIN
...
Proof.
  ...
  - unfold Cmul. simpl. ring.
Qed.
   CAG zero-dependent Lemma weight_space_scale theories/Kahler/sl2/Basic.v:431 END *)
...
(* CAG zero-dependent Lemma orbit_weight theories/Kahler/sl2/Basic.v:587 BEGIN
...
Qed.
   CAG zero-dependent Lemma orbit_weight theories/Kahler/sl2/Basic.v:587 END *)
...
(* CAG zero-dependent Lemma orbit_X_step theories/Kahler/sl2/Basic.v:607 BEGIN
...
Qed.
   CAG zero-dependent Lemma orbit_X_step theories/Kahler/sl2/Basic.v:607 END *)
