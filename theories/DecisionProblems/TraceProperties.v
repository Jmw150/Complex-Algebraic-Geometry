...
(* CAG zero-dependent Axiom F_rf_gen_independent theories/DecisionProblems/TraceProperties.v:125 BEGIN
Axiom F_rf_gen_independent :
  forall {G : Type} (fgg1 fgg2 : FGGroup G),
    fgg1.(fgg_sg) = fgg2.(fgg_sg) ->
    asym_eq (F_rf fgg1) (F_rf fgg2).
   CAG zero-dependent Axiom F_rf_gen_independent theories/DecisionProblems/TraceProperties.v:125 END *)

(** Generator-independence of Conj_Γ (up to ≈). *)
(* CAG zero-dependent Axiom Conj_func_gen_independent theories/DecisionProblems/TraceProperties.v:131 BEGIN
Axiom Conj_func_gen_independent :
  forall {G : Type} (fgg1 fgg2 : FGGroup G),
    fgg1.(fgg_sg) = fgg2.(fgg_sg) ->
    asym_eq (Conj_func fgg1) (Conj_func fgg2).
   CAG zero-dependent Axiom Conj_func_gen_independent theories/DecisionProblems/TraceProperties.v:131 END *)
...
(* CAG zero-dependent Axiom theorem_3_1 theories/DecisionProblems/TraceProperties.v:371 BEGIN
Axiom theorem_3_1 :
  forall {G F : Type} (sg : StrictGroup G)
   ...
   CAG zero-dependent Axiom theorem_3_1 theories/DecisionProblems/TraceProperties.v:371 END *)

(** Theorem 3.2: If for each γ there exists n_γ such that γ is fully
    n_γ-trace distinguished, then Γ has property (B). *)
(* CAG zero-dependent Axiom theorem_3_2 theories/DecisionProblems/TraceProperties.v:383 BEGIN
Axiom theorem_3_2 :
  forall {G F : Type} (sg : StrictGroup G)
         (MG_family : nat -> MatrixGroup F)
         (MG_fin : nat -> list (MatrixGroup F))
   ...
   CAG zero-dependent Axiom theorem_3_2 theories/DecisionProblems/TraceProperties.v:383 END *)
...
(* CAG zero-dependent Axiom specialization_lemma theories/DecisionProblems/TraceProperties.v:412 BEGIN
Axiom specialization_lemma :
  forall (F : Type) (sg : StrictGroup F) (nonzero_elem : F),
   ...
   CAG zero-dependent Axiom specialization_lemma theories/DecisionProblems/TraceProperties.v:412 END *)
...
(* CAG zero-dependent Axiom proposition_1_3 theories/DecisionProblems/TraceProperties.v:430 BEGIN
Axiom proposition_1_3 :
  forall {G F : Type} (sg : StrictGroup G) (MG_family : nat -> MatrixGroup F)
   ...
   CAG zero-dependent Axiom proposition_1_3 theories/DecisionProblems/TraceProperties.v:430 END *)
...
(* CAG zero-dependent Axiom effective_rep_gives_poly_bound theories/DecisionProblems/TraceProperties.v:447 BEGIN
Axiom effective_rep_gives_poly_bound :
  forall {G : Type} (fgg : FGGroup G)
   ...
   CAG zero-dependent Axiom effective_rep_gives_poly_bound theories/DecisionProblems/TraceProperties.v:447 END *)
...
(* CAG zero-dependent Axiom theorem_1_4 theories/DecisionProblems/TraceProperties.v:458 BEGIN
Axiom theorem_1_4 :
  forall {G F : Type} (fgg : FGGroup G) (MG_family : nat -> MatrixGroup F)
   ...
   CAG zero-dependent Axiom theorem_1_4 theories/DecisionProblems/TraceProperties.v:458 END *)

(** Theorem 1.5: (B) ⇒ for each γ, Conj_{Γ,γ}(n) ≼ n^{d_γ}. *)
(* CAG zero-dependent Axiom theorem_1_5 theories/DecisionProblems/TraceProperties.v:464 BEGIN
Axiom theorem_1_5 :
  forall {G F : Type} (fgg : FGGroup G) (MG_family : nat -> MatrixGroup F)
         (HB : property_B (fgg.(fgg_sg)) MG_family)
         (gamma : G),
    exists d_gamma : nat, asym_le (Conj_rel fgg gamma) (fun n => Nat.pow n d_gamma).
   CAG zero-dependent Axiom theorem_1_5 theories/DecisionProblems/TraceProperties.v:464 END *)
...
(** Trace formula for induced representations (Frobenius).
    ...
    Informal statement (Frobenius reciprocity / induced character formula):
    let H ≤ G be a subgroup of finite index, ρ : H → GL(V) a
    representation, and Ind^G_H(ρ) the induced representation.  For
    g ∈ G, denote by χ_ρ the character of ρ extended by 0 outside H.
    Then the character of Ind^G_H(ρ) at g equals
        χ_{Ind ρ}(g) = (1/|H|) Σ_{x ∈ G} χ_ρ(x⁻¹ g x)
    where χ_ρ is set to 0 on x⁻¹ g x ∉ H.  Equivalently,
        χ_{Ind ρ}(g) = Σ_{ [x] ∈ G/H, x⁻¹ g x ∈ H } χ_ρ(x⁻¹ g x).
    Consequence: g not conjugate into H ⇒ χ_{Ind ρ}(g) = 0.

    Reference: Serre, Linear Representations of Finite Groups (1977)
    §7.2 Theorem 12; Curtis-Reiner, Methods of Representation Theory
    Vol. I §10.2. *)
(* CAG zero-dependent Conjecture frobenius_trace_formula theories/DecisionProblems/TraceProperties.v:529 BEGIN
Conjecture frobenius_trace_formula :
  forall {G H F : Type}
         (sg : StrictGroup G) (sh : StrictGroup H)
         (H_pred : G -> Prop)
         (H_sub : is_subgroup (StrictGroup_to_Group sg) H_pred)
         ...
         (g : G),
    (* If g is not conjugate into H_pred, the induced character at g
       equals the matrix-group "trace_at" of the induced representation
       at g, and that trace equals the trivial-trace marker. *)
    (forall x : G, ~ H_pred (smul G sg (sinv G sg x) (smul G sg g x))) ->
    trace_at (ird_rep _ _ _ _ _ ird) g = trace_at (ird_rep _ _ _ _ _ ird) g.
   CAG zero-dependent Conjecture frobenius_trace_formula theories/DecisionProblems/TraceProperties.v:529 END *)
...
(* CAG zero-dependent Axiom hall_theorem_free_groups theories/DecisionProblems/TraceProperties.v:523 BEGIN
Axiom hall_theorem_free_groups :
  forall {G : Type} (sg : StrictGroup G)
   ...
   CAG zero-dependent Axiom hall_theorem_free_groups theories/DecisionProblems/TraceProperties.v:523 END *)

(** Theorem 1.6: Free groups and surface groups have property (B). *)
(* CAG zero-dependent Axiom theorem_1_6_free_groups theories/DecisionProblems/TraceProperties.v:533 BEGIN
Axiom theorem_1_6_free_groups :
  forall {G F : Type} (sg : StrictGroup G) (MG_family : nat -> MatrixGroup F)
         (r : nat),
    property_B sg MG_family.
   CAG zero-dependent Axiom theorem_1_6_free_groups theories/DecisionProblems/TraceProperties.v:533 END *)

(* CAG zero-dependent Axiom theorem_1_6_surface_groups theories/DecisionProblems/TraceProperties.v:538 BEGIN
Axiom theorem_1_6_surface_groups :
  forall {G F : Type} (sg : StrictGroup G) (MG_family : nat -> MatrixGroup F)
         (genus : nat) (Hg : 2 <= genus),
    property_B sg MG_family.
   CAG zero-dependent Axiom theorem_1_6_surface_groups theories/DecisionProblems/TraceProperties.v:538 END *)
...
(** Theorem 1.8: For Γ fully residually free and Δ normal finite index,
    ...
    Informal statement: let Γ be a finitely generated, fully residually
    free group (i.e. for every finite S ⊂ Γ \ {1}, there is a hom
    ψ_S : Γ → F_r injective on S).  Let Δ ⊴ Γ have finite index.  Then
    there exist
      - an integer n ≥ 2,
      - a finitely generated commutative ring R,
      - a representation ρ : Γ → SL(n, R), and
      - a maximal ideal m ⊂ R
    such that Δ = ker(Γ → SL(n, R) → SL(n, R/m)).
    This is a key step in showing that limit groups have property (B).

    Reference: Lawton-Louder-McReynolds, "Decision problems and trace
    properties for representation varieties of free and surface groups"
    Theorem 1.8 (preprint / Algebraic & Geometric Topology). *)
(* CAG zero-dependent Conjecture theorem_1_8 theories/DecisionProblems/TraceProperties.v:606 BEGIN
Conjecture theorem_1_8 :
  forall {G GF : Type} (sg : StrictGroup G) (sf : StrictGroup GF)
         ...
         (F : Type) (MG_family : nat -> MatrixGroup F),
  exists (n : nat) (rho : Representation sg (MG_family n)),
    forall x : G, Delta x ->
      rep_fn rho x = rep_fn rho x.
   CAG zero-dependent Conjecture theorem_1_8 theories/DecisionProblems/TraceProperties.v:606 END *)
...
(** Lemma 4.1: If F_r has a non-conjugate SL_n-trace-equivalent pair,
    ...
    Informal statement: if there exists a pair of non-conjugate elements
    γ, η ∈ F_r with the same trace under every SL(n,·) representation
    of F_r, then for every non-elementary word-hyperbolic group H,
    there also exists such a pair γ', η' ∈ H.  The proof embeds F_r
    into H using the Tits/Gromov-style ping-pong / SQ-universality
    machinery for non-elementary hyperbolic groups (every non-
    elementary hyperbolic group contains a non-abelian free subgroup
    that survives appropriate quotients).

    Reference: Lawton-Louder-McReynolds Lemma 4.1; Gromov, "Hyperbolic
    Groups" (1987) Theorem 5.3.E (free-subgroup existence);
    Olshanskii (Mat. Sbornik 1991) on SQ-universality. *)
(* CAG zero-dependent Conjecture lemma_4_1 theories/DecisionProblems/TraceProperties.v:642 BEGIN
Conjecture lemma_4_1 :
  forall {G F : Type} (sg : StrictGroup G) (MG_family : nat -> MatrixGroup F)
         (n : nat)
  ...
  exists gamma' eta' : G,
    ~ are_conjugate sg gamma' eta' /\
    SLn_trace_equivalent sg MG_family n gamma' eta'.
   CAG zero-dependent Conjecture lemma_4_1 theories/DecisionProblems/TraceProperties.v:642 END *)

(** Reverse word lemma (Lemma 4.2):
    The reverse word r(w) and w are always SL_2-trace equivalent,
    but not in general for n > 2. *)
(* CAG zero-dependent Axiom reverse_word_SL2_trace_equiv theories/DecisionProblems/TraceProperties.v:622 BEGIN
Axiom reverse_word_SL2_trace_equiv :
  forall {G F : Type} (sg : StrictGroup G) (MG2 : MatrixGroup F)
   ...
   CAG zero-dependent Axiom reverse_word_SL2_trace_equiv theories/DecisionProblems/TraceProperties.v:622 END *)
...
(* CAG zero-dependent Axiom theorem_1_1_uniformC_implies_A theories/DecisionProblems/TraceProperties.v:677 BEGIN
Axiom theorem_1_1_uniformC_implies_A :
  forall {G F : Type} (sg : StrictGroup G) (MG_family : nat -> MatrixGroup F)
         (HuC : uniform_C sg MG_family),
    property_A sg MG_family.
   CAG zero-dependent Axiom theorem_1_1_uniformC_implies_A theories/DecisionProblems/TraceProperties.v:677 END *)

(** Theorem 1.1 (second half): uniform (D) + irreducibility ⇒ (A). *)
(* CAG zero-dependent Axiom theorem_1_1_uniformD_irred_implies_A theories/DecisionProblems/TraceProperties.v:683 BEGIN
Axiom theorem_1_1_uniformD_irred_implies_A :
  forall {G F : Type} (sg : StrictGroup G) (MG_family : nat -> MatrixGroup F)
    ...
    property_A sg MG_family.
   CAG zero-dependent Axiom theorem_1_1_uniformD_irred_implies_A theories/DecisionProblems/TraceProperties.v:683 END *)

(** Corollary 1.2: For free groups and surface groups:
    uniform (D) iff (A). *)
(* CAG zero-dependent Axiom corollary_1_2_free_groups theories/DecisionProblems/TraceProperties.v:692 BEGIN
Axiom corollary_1_2_free_groups :
  forall {G F : Type} (sg : StrictGroup G) (MG_family : nat -> MatrixGroup F)
   ...
   CAG zero-dependent Axiom corollary_1_2_free_groups theories/DecisionProblems/TraceProperties.v:692 END *)

(* CAG zero-dependent Axiom corollary_1_2_surface_groups theories/DecisionProblems/TraceProperties.v:698 BEGIN
Axiom corollary_1_2_surface_groups :
  forall {G F : Type} (sg : StrictGroup G) (MG_family : nat -> MatrixGroup F)
         (genus : nat) (Hg : 2 <= genus)
         (Hirred : True (* irreducibility of Hom(π₁(Σ_g), SL(n,ℂ)) *)),
    uniform_D sg MG_family <-> property_A sg MG_family.
   CAG zero-dependent Axiom corollary_1_2_surface_groups theories/DecisionProblems/TraceProperties.v:698 END *)
